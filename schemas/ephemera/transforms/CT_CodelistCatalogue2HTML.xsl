...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" 
  ...
  <xd:doc scope="stylesheet">
    <xd:desc>
      ...
      <xd:p><xd:b>Updated: </xd:b>September 10, 2017</xd:p>
      <xd:p>Added Catalog information and summary fields (counts of codelists and items), updated Version date</xd:p>     
      <xd:p><xd:b>Adapted for S-100 codelists:</xd:b>Raphael Malyankar</xd:p>
      <xd:p><xd:b>Updated: </xd:b>May 02, 2019</xd:p>
  </xd:desc>
  </xd:doc>
  <xsl:param name="contents"/>
  <xsl:variable name="stylesheetName" select="'CT_CodelistHTML.xsl'"/>
  <xsl:variable name="stylesheetVersion" select="'2019-05-02'"/>
  <xsl:template match="/">
    <html>
      <a name="top"/>
      <h1>Codelist Catalog</h1>
      <p>This report describes an ISO TC211 or S-100 codelist catalog, the codelist(s) in the catalog, and the values and definitions of the codes.</p>
      <p> Original stylesheet by Ted Habermann for ISO TC211 codelists.</p>
      <p> Stylesheet adapted by Raphael Malyankar for the S-100 codelists.</p>
      <h2>Catalog</h2>
      ...
      <hr/>
      <h2>Codelists</h2>
      <!-- Contents removed - S-100 added more codelists. -->
      ...
      <xsl:for-each select="//cat:CT_Codelist">
        ...
        <b>Definition: </b><xsl:value-of select="cat:definition"/><br/>
        <b>CodeSpace: </b><xsl:value-of select="cat:identifier/gco:ScopedName/@codeSpace"/><br/>
        <b>Description: </b><xsl:value-of select="cat:description"/><br/>
        <b>Number of items: </b><xsl:value-of select="count(cat:codeEntry)"/>
        <table width="95%" border="1" cellpadding="2" cellspacing="2">
          <tr>
          ...
          <xsl:for-each select="cat:codeEntry">
            ...
            <xsl:variable name="description" select="cat:CT_CodelistValue/cat:description"/>
            <tr>
              <td valign="top">
